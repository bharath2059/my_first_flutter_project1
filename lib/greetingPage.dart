    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: Column(
          ...
          children: [
            const Center(child: Text("Welcome  to My Flutter Project",style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600))),
            Image.asset("assets/images/welcomeimage.jpg",height: 300,width: 300,)
